...
//        return found ? found.name : -1;
    ...
    document.getElementById("artist52").innerHTML = findByAge(artists, 52)
    document.getElementById("artist34").innerHTML = findByAge(artists, 34)
    
    document.getElementById('averageage').innerHTML = avarageAge(artists)
