(function ($) {
    ...
    var assetLoader = (function () {
        ...
        this.imgs = {
            ...
            'fires': 'imgs/fires.png',
            'grass': 'imgs/grass.png',
            'drag': 'imgs/drag.png',
            'barrel': 'imgs/barrel.png'
        };

        this.sounds = {
            'bg': 'sounds/bg.mp3',
            'bgMenu': 'sounds/bgMenu.mp3',
    ...
    function updateEnemies() {
        ...
        for (var i = 0; i < enemies.length; i++) {
            ...
            var angle;
            if (player.minDist(enemies[i]) <= player.width * 0.75 - platformWidth / 2) {
                gameOver();
            }
        }
    ...
    function mainMenu() {
        ...
        assetLoader.sounds.bgMenu.play();
    }
    ...
    function startGame() {
        ...
        assetLoader.sounds.bgMenu.pause();
        assetLoader.sounds.gameOver.pause();
        assetLoader.sounds.bg.currentTime = 0;
